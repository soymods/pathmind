...
public final class PathmindIconRenderer {
    ...
    public static void drawPlay(DrawContext context, int buttonX, int buttonY, int buttonSize, int color) {
    ...
    public static void drawStop(DrawContext context, int buttonX, int buttonY, int buttonSize, int color) {
    ...
    public static void drawSearch(DrawContext context, int x, int y, int color) {
    ...
    public static void drawPublishArrow(DrawContext context, int buttonX, int buttonY, int buttonSize, int color) {
    ...
    public static void drawSettings(DrawContext context, int buttonX, int buttonY, int buttonSize,
    ...
    public static void drawPencil(DrawContext context, int x, int y, int size, int color) {
    ...
    public static void drawTrash(DrawContext context, int x, int y, int size, int color) {
    ...
    public static void drawCloseX(DrawContext context, int x, int y, int size, int color) {
