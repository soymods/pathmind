...
public final class UiUtilsDependencyChecker {
    ...
    public static boolean isUiUtilsPresent() {
        ...
        try {
            ...
            PathmindCommon.LOGGER.info("UI Utils detected but incompatible; integration disabled.");
            cachedResult = Boolean.FALSE;
        } catch (LinkageError e) {
            PathmindCommon.LOGGER.info("UI Utils failed to initialize; integration disabled.");
            cachedResult = Boolean.FALSE;
        } catch (Throwable t) {
            PathmindCommon.LOGGER.info("UI Utils check failed unexpectedly; integration disabled.");
            cachedResult = Boolean.FALSE;
        }
