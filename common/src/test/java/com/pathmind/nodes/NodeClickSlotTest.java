...
class NodeClickSlotTest {
    ...
    void eachModeSendsTheClickVanillaSendsForTheSameInput() {
        ...
        assertEquals(ClickType.PICKUP,
            NodeInventoryCommandExecutor.clickSlotClickType(NodeMode.CLICK_SLOT_RIGHT));
        ...
        assertEquals(1, NodeInventoryCommandExecutor.clickSlotButton(NodeMode.CLICK_SLOT_RIGHT));
    ...
    void clickSlotOffersItsThreeModesWithLeftClickAsTheDefault() {
        ...
        assertEquals(4, NodeMode.getModesForNodeType(NodeType.CLICK_SLOT).length);
    }
