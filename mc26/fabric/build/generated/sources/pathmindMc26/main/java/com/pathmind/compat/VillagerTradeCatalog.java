...
/** Typed adapter for Minecraft 26.x data-driven villager trade registries. */
public final class VillagerTradeCatalog {
    ...
    public static List<Offer> load(
        ...
        Villager villager = new Villager(net.minecraft.world.entity.EntityTypes.VILLAGER, serverLevel);
