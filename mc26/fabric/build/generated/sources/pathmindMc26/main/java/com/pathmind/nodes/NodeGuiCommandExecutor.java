...
final class NodeGuiCommandExecutor {
            ...
            runOnClientThread(client, () -> {
                ...
                switch (uiMode) {
                    ...
                    case UI_UTILS_SAVE_GUI:
                        ...
                        if (!com.pathmind.util.UiUtilsProxy.setStoredScreen(client.gui.screen(), client.player.containerMenu)) {
                    ...
                    case UI_UTILS_RESTORE_GUI: {
                        ...
                        client.gui.setScreen(storedScreen);
    ...
    private void copyGuiTitleJson(net.minecraft.client.Minecraft client) {
        String json = new com.google.gson.Gson().toJson(
            net.minecraft.network.chat.ComponentSerialization.CODEC.encodeStart(com.mojang.serialization.JsonOps.INSTANCE, client.gui.screen().getTitle()).getOrThrow()
        );
