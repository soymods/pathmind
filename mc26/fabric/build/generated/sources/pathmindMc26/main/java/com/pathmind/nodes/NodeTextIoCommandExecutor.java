...
final class NodeTextIoCommandExecutor {
    ...
    void executeWriteBookCommand(CompletableFuture<Void> future) {
        ...
        if (!(client.gui.screen() instanceof BookEditScreen)) {
        ...
        BookEditScreen bookScreen = (BookEditScreen) client.gui.screen();
                        ...
                        client.execute(() -> {
                            if (playerFinal != null) {
                                ...
                                if (bookEditScreen != null) {
                                    client.gui.setScreen(bookEditScreen);
                                }
                            }
                        });
                    }
    ...
    void executeWriteSignCommand(CompletableFuture<Void> future) {
        ...
        if (!(client.gui.screen() instanceof AbstractSignEditScreen)) {
        ...
        final AbstractSignEditScreen signScreen = (AbstractSignEditScreen) client.gui.screen();
        client.execute(() -> {
            try {
                    ...
                    Minecraft.getInstance().execute(() -> {
                        ...
                        if (currentClient.player != null) {
                            if (isMessageClientSide()) {
                                currentClient.player.sendSystemMessage(Component.literal(sendText));
