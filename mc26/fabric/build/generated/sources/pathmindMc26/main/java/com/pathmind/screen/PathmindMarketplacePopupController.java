...
final class PathmindMarketplacePopupController {
    ...
    void renderPresetPopup(GuiGraphicsExtractor context, int mouseX, int mouseY, PathmindMarketplaceScreen.Layout layout) {
        ...
        context.text(screen.textRenderer(), Component.translatable("pathmind.marketplace.presetDetails"), popupX + 12, popupY + 10,
        ...
        context.horizontalLine(popupX, popupX + popupWidth - 1, popupY + 28,
        ...
        if (screen.popupMetadataEditing) {
            ...
            context.text(screen.textRenderer(),
        ...
        context.text(screen.textRenderer(), Component.literal(visibilityLabel), textX, visibilityY,
        ...
        context.text(screen.textRenderer(), Component.translatable("pathmind.marketplace.about"), textX + 8, descriptionTop + 6,
        ...
        if (screen.popupMetadataEditing) {
            ...
            if (screen.publishDescriptionField != null) {
                ...
                screen.publishDescriptionField.extractRenderState(context, mouseX, mouseY, 0f);
            }
        ...
        context.text(screen.textRenderer(), Component.translatable("pathmind.marketplace.compatibility"), textX + 8, cursorY + 14,
            screen.presetPopupAnimation.getAnimatedPopupColor(UITheme.TEXT_LABEL));
        context.text(screen.textRenderer(), Component.literal(TextRenderUtil.trimWithEllipsis(screen.textRenderer(),
    ...
    void renderAccountPopup(GuiGraphicsExtractor context, int mouseX, int mouseY, PathmindMarketplaceScreen.Layout layout) {
    ...
    void renderPublishPopup(GuiGraphicsExtractor context, int mouseX, int mouseY, PathmindMarketplaceScreen.Layout layout) {
        ...
        context.text(screen.textRenderer(), Component.translatable("pathmind.field.visibility"), contentX, visibilityLabelY,
    ...
    void renderConfirmPopup(GuiGraphicsExtractor context, int mouseX, int mouseY, PathmindMarketplaceScreen.Layout layout) {
        ...
        context.centeredText(screen.textRenderer(), Component.literal(title),
        ...
        if (confirmAction == PathmindMarketplaceScreen.ConfirmAction.UPDATE) {
            ...
            context.text(screen.textRenderer(), Component.translatable("pathmind.marketplace.sourcePreset"), sourceX, sourceLabelY,
        ...
        context.text(screen.textRenderer(), Component.translatable("pathmind.option.dontShowAgain"),
    ...
    private int drawPublishField(GuiGraphicsExtractor context, int mouseX, int mouseY, int x, int y, int width, int height,
    ...
    private void renderUpdateConfirmSourceDropdown(GuiGraphicsExtractor context, int mouseX, int mouseY, int popupX, int popupY, int popupWidth) {
