...
final class PathmindPresetPopupController {
    ...
    void renderCreatePresetPopup(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        int popupHeight = screen.getCreateNamingPopupHeight();
    ...
    void renderPublishPresetPopup(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        if (screen.publishPresetSession == null) {
            ...
            context.text(screen.textRenderer(), Component.literal(accountLabel), accountTextX, accountTextY,
                screen.getPopupAnimatedColor(screen.publishPresetPopupAnimation, UITheme.TEXT_SECONDARY));
        }
        PathmindPopupRenderer.drawButton(
            context,
    ...
    void renderRenamePresetPopup(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
    ...
    void renderPresetDeletePopup(GuiGraphicsExtractor context, int mouseX, int mouseY) {
    ...
    private void renderPresetTextField(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta, EditBox field,
    ...
    private void renderPublishPresetField(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta, EditBox field,
    ...
    private void renderPublishVisibilityToggle(GuiGraphicsExtractor context, int mouseX, int mouseY, PathmindPopupLayout.Rect row, PathmindPopupLayout.Rect toggle) {
    ...
    private void renderButtonRow(GuiGraphicsExtractor context, int mouseX, int mouseY, PathmindPopupLayout.ButtonRow buttonRow,
