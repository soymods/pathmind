...
public final class PathmindRoutineUi {
    ...
    public static boolean renderReturnButton(GuiGraphicsExtractor context, int x, int y, int size,
    ...
    public static void renderRoutineMarker(GuiGraphicsExtractor context, int x, int y, int size,
    ...
    public static void renderSidebarActionButton(GuiGraphicsExtractor context, int x, int y, int size,
    ...
    public static void renderInputAction(GuiGraphicsExtractor context, Font textRenderer, String symbol,
        ...
        context.text(textRenderer, Component.literal(symbol), x, y, color);
    }

    public static void renderDropTarget(GuiGraphicsExtractor context, Font textRenderer, int x, int y,
        ...
        context.text(textRenderer, Component.literal(label), labelX,
