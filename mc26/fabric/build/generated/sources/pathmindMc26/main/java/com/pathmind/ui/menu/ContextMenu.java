...
public class ContextMenu {
    ...
    public void render(GuiGraphicsExtractor context, Font textRenderer, int mouseX, int mouseY) {
        ...
        context.text(textRenderer, Component.translatable(SEARCH_LABEL_KEY), searchTextX, searchTextY, UITheme.CONTEXT_MENU_TEXT);
        ...
        context.text(textRenderer, Component.translatable(STICKY_NOTE_LABEL_KEY), noteTextX, noteTextY, UITheme.CONTEXT_MENU_TEXT);
