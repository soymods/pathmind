...
public final class NodeErrorNotificationOverlay {
    ...
    public synchronized void render(GuiGraphicsExtractor context, Font textRenderer, int screenWidth, int screenHeight) {
        ...
        while (iterator.hasNext()) {
            ...
            if (wrappedLines.isEmpty()) {
                wrappedLines = List.of(Component.literal(entry.message).getVisualOrderText());
            }
            ...
            for (FormattedCharSequence line : wrappedLines) {
                context.text(textRenderer, line, x + textStartX, textY, borderColor);
