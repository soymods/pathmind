...
public final class UIStyleHelper {
    ...
    public static void drawPanel(GuiGraphicsExtractor context, int x, int y, int width, int height, int backgroundColor, int borderColor) {
    ...
    public static void drawTextButtonFrame(GuiGraphicsExtractor context, int x, int y, int width, int height,
    ...
    public static void drawFieldFrame(GuiGraphicsExtractor context, int x, int y, int width, int height, FieldPalette palette) {
        if (palette == null) {
            return;
        }
    ...
    public static void drawDropdownRow(GuiGraphicsExtractor context, int x, int y, int width, int height, DropdownRowPalette palette) {
    ...
    public static void drawScrollContainer(GuiGraphicsExtractor context, int x, int y, int width, int height, ScrollContainerPalette palette) {
        if (palette == null) {
            return;
        }
        drawBeveledPanel(context, x, y, width, height, palette.backgroundColor(), palette.borderColor(), palette.innerBorderColor());
    ...
    public static void drawToggleSwitch(GuiGraphicsExtractor context, int x, int y, int width, int height, float progress, TogglePalette palette) {
    ...
    public static void drawSliderTrack(GuiGraphicsExtractor context, int x, int y, int width, int height, SliderPalette palette) {
        if (context == null || palette == null || width <= 0 || height <= 0) {
            return;
        }
    ...
    public static void drawSliderHandle(GuiGraphicsExtractor context, int x, int y, int width, int height, SliderPalette palette) {
        if (context == null || palette == null || width <= 0 || height <= 0) {
            return;
        }
    ...
    public static void drawChevron(GuiGraphicsExtractor context, int centerX, int centerY, boolean expanded, int color) {
        if (expanded) {
            context.horizontalLine(centerX - 3, centerX + 3, centerY - 2, color);
            context.horizontalLine(centerX - 2, centerX + 2, centerY - 1, color);
            context.horizontalLine(centerX - 1, centerX + 1, centerY, color);
            return;
        }
        context.horizontalLine(centerX - 3, centerX + 3, centerY + 1, color);
        context.horizontalLine(centerX - 2, centerX + 2, centerY, color);
        context.horizontalLine(centerX - 1, centerX + 1, centerY - 1, color);
    }

    public static void drawTextCaret(GuiGraphicsExtractor context, int caretX, int topY, int bottomY, int color) {
        drawTextCaret(context, caretX, topY, bottomY, caretX + 1, color);
    }

    public static void drawTextCaret(GuiGraphicsExtractor context, int caretX, int topY, int bottomY, int maxRight, int color) {
        if (context == null) {
            return;
        }
    ...
    public static void drawTextCaretAtBaseline(GuiGraphicsExtractor context, Font textRenderer, int caretX, int baselineY, int maxRight, int color) {
