...
public final class TooltipRenderer {
    ...
    public static void render(GuiGraphicsExtractor context, Font textRenderer, String text, int mouseX, int mouseY,
        ...
        int textY = y + PADDING;
        for (String line : lines) {
            context.text(textRenderer, Component.literal(line), textX, textY, UITheme.TEXT_PRIMARY);
