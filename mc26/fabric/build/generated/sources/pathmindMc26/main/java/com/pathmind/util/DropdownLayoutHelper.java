...
public final class DropdownLayoutHelper {
    ...
    public static void enableRevealScissor(GuiGraphicsExtractor context, int x, int y, int width, int fullHeight, float progress) {
        enableRevealScissor(context, x, y, width, fullHeight, progress, 0);
    }

    public static void enableRevealScissor(GuiGraphicsExtractor context, int x, int y, int width, int fullHeight, float progress, int bottomPadding) {
        if (context == null) {
            return;
        }
    ...
    public static void drawOutline(net.minecraft.client.gui.GuiGraphicsExtractor context,
                                   int x,
                                   int y,
                                   int width,
                                   int height,
    ...
    public static void drawScrollBar(net.minecraft.client.gui.GuiGraphicsExtractor context,
                                     int x,
                                     int y,
                                     int width,
                                     int height,
