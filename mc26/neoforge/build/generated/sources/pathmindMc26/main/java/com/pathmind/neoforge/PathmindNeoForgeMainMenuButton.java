...
final class PathmindNeoForgeMainMenuButton extends Button {
    ...
    private void renderPathmindButton(GuiGraphicsExtractor context) {
        setTooltip(Tooltip.create(OPEN_EDITOR));
    ...
    private void drawButtonBackground(GuiGraphicsExtractor context) {
    ...
    private static boolean drawIcon(GuiGraphicsExtractor context, int x, int y, int size) {
    ...
    private static boolean invokePipelineBlit(GuiGraphicsExtractor context, Object texture, int x, int y, int size) {
        try {
    ...
    private static boolean invokeLegacyBlit(GuiGraphicsExtractor context, Object texture, int x, int y, int size) {
        try {
            Method method = context.getClass().getMethod(
                "blit",
                texture.getClass(),
