...
final class PathmindCursor {
    ...
    static void renderDefault(GuiGraphicsExtractor context, int mouseX, int mouseY) {
        render(context, DEFAULT_TEXTURE, mouseX, mouseY);
    }

    static void render(GuiGraphicsExtractor context, Identifier texture, int mouseX, int mouseY) {
