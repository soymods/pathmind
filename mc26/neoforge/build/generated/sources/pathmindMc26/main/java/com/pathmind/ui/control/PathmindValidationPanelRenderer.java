...
public final class PathmindValidationPanelRenderer {
    ...
    public static boolean renderValidationButton(GuiGraphicsExtractor context,
                                                 Font textRenderer,
    ...
    public static int renderPanelAndIssues(GuiGraphicsExtractor context, Font textRenderer,
                                           int mouseX, int mouseY,
                                           GraphValidationResult validationResult,
    ...
    public static void renderFooter(GuiGraphicsExtractor context, Font textRenderer,
                                    GraphValidationResult validationResult,
                                    int panelX, int panelY, int panelWidth, int panelHeight,
        ...
        context.horizontalLine(panelX + 1, panelX + panelWidth - 2, footerY, UITheme.BORDER_SUBTLE);
        context.text(
            textRenderer,
    ...
    private static void renderIssueRow(GuiGraphicsExtractor context, Font textRenderer,
        ...
        context.horizontalLine(panelX + 1, panelX + panelWidth - 2, rowY, UITheme.BORDER_SUBTLE);
        ...
        for (FormattedCharSequence line : wrappedLines) {
            context.text(textRenderer, line, panelX + 18, textY, rowTextColor);
    ...
    private static void drawConsoleIcon(GuiGraphicsExtractor context, int buttonX, int buttonY, int color) {
        int left = buttonX + 4;
        int top = buttonY + 4;
    ...
    private static void drawAlertIcon(GuiGraphicsExtractor context, int buttonX, int buttonY, int buttonSize, int color) {
    ...
    private static void drawCountBadge(GuiGraphicsExtractor context, Font textRenderer,
        ...
        context.text(textRenderer, Component.literal(text), badgeX + (badgeSize - textWidth) / 2, badgeY + 1,
            UITheme.TEXT_PRIMARY);
    }
