...
public final class PathmindWorkspaceChrome {
    ...
    public interface IconPainter {
        void draw(GuiGraphicsExtractor context, int x, int y, int size, int color);
    }
    ...
    public static boolean renderButtonFrame(GuiGraphicsExtractor context, int x, int y, int width, int height,
    ...
    public static boolean renderIconButton(GuiGraphicsExtractor context, int x, int y, int size,
                                           int mouseX, int mouseY, boolean active, boolean disabled,
    ...
    public static void drawToolbarButtonFrame(GuiGraphicsExtractor context, int x, int y, int width, int height,
    ...
    public static boolean renderMarketplaceButton(GuiGraphicsExtractor context, Font textRenderer,
        ...
        context.text(textRenderer, Component.literal(label), textX, textY, textColor);
        return hovered;
    }

    public static boolean renderPublishButton(GuiGraphicsExtractor context, int x, int y, int size,
                                              int mouseX, int mouseY, float hoverProgress,
    ...
    public static boolean renderPlayButton(GuiGraphicsExtractor context, int x, int y, int size,
    ...
    public static boolean renderStopButton(GuiGraphicsExtractor context, int x, int y, int size,
                                           int mouseX, int mouseY, boolean disabled,
                                           boolean executing, float hoverProgress,
                                           int accentColor) {
        boolean hovered = !disabled && contains(mouseX, mouseY, x, y, size, size);
    ...
    public static void drawHomeIcon(GuiGraphicsExtractor context, int buttonX, int buttonY, int buttonSize, int color) {
        int centerX = buttonX + buttonSize / 2;
        int centerY = buttonY + buttonSize / 2;
        context.horizontalLine(centerX - 4, centerX + 2, centerY, color);
        context.verticalLine(centerX - 4, centerY - 4, centerY + 2, color);
        context.horizontalLine(centerX - 2, centerX, centerY - 2, color);
        context.horizontalLine(centerX - 3, centerX - 1, centerY - 1, color);
        context.verticalLine(centerX - 2, centerY - 2, centerY, color);
        context.verticalLine(centerX - 3, centerY - 3, centerY - 1, color);
    }

    public static void drawClearIcon(GuiGraphicsExtractor context, int buttonX, int buttonY, int buttonSize, int color) {
        int centerX = buttonX + buttonSize / 2;
        int top = buttonY + 4;
        int bottom = buttonY + buttonSize - 4;
        context.horizontalLine(centerX - 5, centerX + 4, top, color);
        context.verticalLine(centerX - 5, top, top + 2, color);
        context.verticalLine(centerX + 4, top, top + 2, color);
        context.horizontalLine(centerX - 4, centerX + 3, top + 2, color);
        context.verticalLine(centerX - 3, top + 2, bottom, color);
        context.verticalLine(centerX + 2, top + 2, bottom, color);
        context.horizontalLine(centerX - 3, centerX + 2, bottom, color);
    }

    public static void drawImportExportIcon(GuiGraphicsExtractor context, int buttonX, int buttonY, int buttonSize, int color) {
        int centerX = buttonX + buttonSize / 2;
        int centerY = buttonY + buttonSize / 2;
        context.verticalLine(centerX - 4, centerY - 5, centerY, color);
        context.horizontalLine(centerX - 6, centerX - 2, centerY - 5, color);
        context.horizontalLine(centerX - 5, centerX - 3, centerY - 4, color);
        context.verticalLine(centerX + 3, centerY, centerY + 5, color);
        context.horizontalLine(centerX + 1, centerX + 5, centerY + 5, color);
        context.horizontalLine(centerX + 2, centerX + 4, centerY + 4, color);
        context.horizontalLine(centerX - 4, centerX + 3, centerY, color);
    }

    public static void drawSettingsIcon(GuiGraphicsExtractor context, int buttonX, int buttonY, int buttonSize, int color) {
