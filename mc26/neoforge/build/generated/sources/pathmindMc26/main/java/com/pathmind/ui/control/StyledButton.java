...
public class StyledButton {
    ...
    public void render(GuiGraphicsExtractor context, Font textRenderer, int mouseX, int mouseY) {
        ...
        context.centeredText(textRenderer, Component.literal(label), textX, textY, textColor);
    }
     ...
     */
    public static void renderSimple(GuiGraphicsExtractor context, Font textRenderer,
        ...
        int textX = x + width / 2;
        int textY = y + (height - textRenderer.lineHeight) / 2 + 1;
        context.centeredText(textRenderer, Component.literal(label), textX, textY, palette.textColor());
    }
