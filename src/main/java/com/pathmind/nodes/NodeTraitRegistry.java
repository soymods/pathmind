...
public final class NodeTraitRegistry {
    ...
    static {
        ...
        accepted.put(NodeType.SENSOR_GUI_FILLED, EnumSet.of(NodeValueTrait.GUI));
        ...
        accepted.put(NodeType.DROP_ITEM, EnumSet.of(NodeValueTrait.ITEM, NodeValueTrait.INVENTORY_SLOT, NodeValueTrait.NUMBER));
        accepted.put(NodeType.DROP_SLOT, EnumSet.of(NodeValueTrait.ITEM, NodeValueTrait.INVENTORY_SLOT, NodeValueTrait.NUMBER));
        ...
        slotCounts.put(NodeType.SENSOR_GUI_FILLED, 1);
        ...
        slotLabels.put(NodeType.SENSOR_GUI_FILLED, new String[]{"GUI"});
    ...
    public static boolean isParameterSlotAlwaysRequired(NodeType hostType, int slotIndex) {
        ...
        if (hostType == NodeType.EVENT_FUNCTION) {
            return false;
        }
        return slotIndex == 0;
    }
